...
const handleClientCancel = () => {
  ...
  return (
    ...
    >
      ...
      >
<Divider variant="h2" sx={{fontWeight:"bold",color:"darkblue"}}>Clients</Divider>  
...
{/* Delete Confirmation Dialog */}
      <Dialog open={openDeleteDialog} onClose={() => setOpenDeleteDialog(false)}>
        <DialogTitle style={{fontWeight:"bold",textAlign:"center",fontFamily:"monospace"}}>Delete Client</DialogTitle> <Divider/>
        <DialogContent>
...
<DialogContent dividers>
  ...
  <DialogActions>
    ...
    <Button variant="outlined" color="error" onClick={() => setSelectedClient(null)}>Close</Button>
  </DialogActions>
</Dialog>
...
>
  ...
  <TextField
    ...
    minRows={1}
    maxRows={6}
    value={newClient.aboutClient}
    onChange={(e) =>
      setNewClient({ ...newClient, aboutClient: e.target.value })
    }
    fullWidth
    sx={{ flex: 2 }} // takes more space if needed
  />
</Stack>

         <Stack
  direction={{ xs: "column", sm: "row" }} // stacked on small screens, row on larger screens
  spacing={2}
  mb={3}
>
  ...
  <TextField
    label="Contact SPOC"
    value={newClient.contactSpoc}
    onChange={(e) =>
      setNewClient({ ...newClient, contactSpoc: e.target.value })
    }
    fullWidth
    sx={{ flex: 1 }}
  />
...
>
  <TextField
    select
    label="GST Applicable?"
    value={newClient.gstApplicable}
    onChange={(e) =>
      setNewClient({ ...newClient, gstApplicable: e.target.value })
    }
    fullWidth
  >
    <MenuItem value="Yes">Yes</MenuItem>
  ...
  <TextField
    ...
    fullWidth
    disabled={newClient.gstApplicable !== "Yes"}
  />

  <TextField
    label="GST %"
    type="number"
    value={newClient.gstPercentage}
    onChange={(e) =>
      setNewClient({ ...newClient, gstPercentage: e.target.value })
    }
    fullWidth
    disabled={newClient.gstApplicable !== "Yes"}
  />
